...
--------------------------------------------------------------------------------
  ...
  images.raw <- LoadImageChannels(channel.filepaths = 
                                    c("~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BASC#6_cytospin/DAPI_BSL.BDL_Cytospin_032224_BASC#6 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d1.TIF",
                                      "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BASC#6_cytospin/HOPX_BSL.BDL_Cytospin_032224_BASC#6 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d0.TIF",
                                      "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BASC#6_cytospin/VIM_BSL.BDL_Cytospin_032224_BASC#6 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d2.TIF",
                                      "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BASC#6_cytospin/SOX9_BSL.BDL_Cytospin_032224_BASC#6 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d3.TIF"
                                    ),
  ...
  # Label with Sample
  output.data$Sample <- 'Pre-Seeding 2' #*************UPDATE NUMBER*************
  
  # Stash so we don't overwrite
  PreSeed2Data <- melt(output.data) #*************UPDATE NUMBER*************
  ...
  --------------------------------------------------------------------------------
    ...
    # LOAD SINGLE CHANNEL IMAGES
    images.raw <- LoadImageChannels(channel.filepaths = 
                                      c("~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BSL2_cytospin/DAPI_BSL.BDL_Cytospin_032224_BSL2_HOP.488_Vimentin.555_SOX9.647_ver2_Bottom Slide_TR_p00_0_A01f00d1.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BSL2_cytospin/HOPX_BSL.BDL_Cytospin_032224_BSL2_HOP.488_Vimentin.555_SOX9.647_ver2_Bottom Slide_TR_p00_0_A01f00d0.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BSL2_cytospin/VIM_BSL.BDL_Cytospin_032224_BSL2_HOP.488_Vimentin.555_SOX9.647_ver2_Bottom Slide_TR_p00_0_A01f00d2.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BSL2_cytospin/SOX9_BSL.BDL_Cytospin_032224_BSL2_HOP.488_Vimentin.555_SOX9.647_ver2_Bottom Slide_TR_p00_0_A01f00d3.TIF"
                                      ),
  ...
  # Label with Sample
  output.data$Sample <- 'BSL2' #*************UPDATE NUMBER*************
  
  # Stash so we don't overwrite
  BSL2Data <- melt(output.data) #*************UPDATE NUMBER*************
  ...
  --------------------------------------------------------------------------------
    ...
    # LOAD SINGLE CHANNEL IMAGES
    images.raw <- LoadImageChannels(channel.filepaths = 
                                      c("~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BDL2_cytospin/DAPI_BSL.BDL_Cytospin_032224_BDL2_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d1.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BDL2_cytospin/HOPX_BSL.BDL_Cytospin_032224_BDL2_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d0.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BDL2_cytospin/VIM_BSL.BDL_Cytospin_032224_BDL2_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d2.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL2/BDL2_cytospin/SOX9BSL.BDL_Cytospin_032224_BDL2_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d3.TIF"
                                      ),
  ...
  # Label with Sample
  output.data$Sample <- 'BDL2' #*************UPDATE NUMBER*************
  
  # Stash so we don't overwrite
  BDL2Data <- melt(output.data) #*************UPDATE NUMBER*************
  ...
  data <- rbind(PreSeed2Data,BSL2Data,BDL2Data) #*************UPDATE NUMBER*************   
  data_sorted <- data
  data_sorted$Sample <- factor(data_sorted$Sample,
                               c("Pre-Seeding 2","BSL2","BDL2")) #*************UPDATE NUMBER*************
  
  png('BSL2.BDL2.BASC6 Violin Plot.png',width = 15,height = 8,units='in',res=1000)
  ...
  #                method = "t.test")+
    ...
    scale_fill_discrete(breaks=c("Pre-Seeding 2","BSL2","BDL2"))    #*************UPDATE NUMBER************* 
