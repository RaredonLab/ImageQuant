...
--------------------------------------------------------------------------------
  ...
  images.raw <- LoadImageChannels(channel.filepaths = 
                                    c("~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BASC#5_cytospin/DAPI_BSL.BDL_Cytospin_032224_BASC#5 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d1.TIF",
                                      "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BASC#5_cytospin/HOPX_BSL.BDL_Cytospin_032224_BASC#5 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d0.TIF",
                                      "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BASC#5_cytospin/VIM_BSL.BDL_Cytospin_032224_BASC#5 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d2.TIF",
                                      "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BASC#5_cytospin/SOX9_BSL.BDL_Cytospin_032224_BASC#5 pre_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d3.TIF"
                                    ),
  ...
  # Label with Sample
  output.data$Sample <- 'Pre-Seeding 3' #*************UPDATE NUMBER*************
  ...
  --------------------------------------------------------------------------------
    ...
    # LOAD SINGLE CHANNEL IMAGES
    images.raw <- LoadImageChannels(channel.filepaths = 
                                      c("~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BSL3_cytospin/DAPI_BSL.BDL_Cytospin_032224_BSL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d1.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BSL3_cytospin/HOPX_BSL.BDL_Cytospin_032224_BSL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d0.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BSL3_cytospin/VIM_BSL.BDL_Cytospin_032224_BSL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d2.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BSL3_cytospin/SOX9_BSL.BDL_Cytospin_032224_BSL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d3.TIF"
                                      ),
  ...
  # Label with Sample
  output.data$Sample <- 'BSL3' #*************UPDATE NUMBER*************
  ...
  --------------------------------------------------------------------------------
    ...
    # LOAD SINGLE CHANNEL IMAGES
    images.raw <- LoadImageChannels(channel.filepaths = 
                                      c("~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BDL3_cytospin/DAPI_BSL.BDL_Cytospin_032224_BDL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d1.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BDL3_cytospin/HOPX_BSL.BDL_Cytospin_032224_BDL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d0.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BDL3_cytospin/VIM_BSL.BDL_Cytospin_032224_BDL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d2.TIF",
                                        "~/project/CytospinQuant/Cytospin Images/BSL.BDL3/BDL3_cytospin/SOX9_BSL.BDL_Cytospin_032224_BDL3_HOP.488_Vimentin.555_SOX9.647_Bottom Slide_TR_p00_0_A01f00d3.TIF"
                                      ),
  ...
  # Label with Sample
  output.data$Sample <- 'BDL3' #*************UPDATE NUMBER*************
  ...
  data <- rbind(PreSeed3Data,BSL3Data,BDL3Data)
  data_sorted <- data
  data_sorted$Sample <- factor(data_sorted$Sample,
                               c("Pre-Seeding 3","BSL3","BDL3"))
  
  png('BSL3.BDL3.BASC5 Violin Plot.png',width = 15,height = 8,units='in',res=1000)
  ...
  #                method = "t.test")+
    ...
    scale_fill_discrete(breaks=c("Pre-Seeding 3","BSL3","BDL3"))    
